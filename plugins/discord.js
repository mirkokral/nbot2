...
//         console.log('[DISCORD] {: }'.replace('{', username).replace('}', msg.content))
...
//     }}
//   });
//   if(process.env.token == "off") return console.log('fard disord farded')
